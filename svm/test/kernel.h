...
#ifndef __SVM_LIGHT_KERNEL_H__
#define __SVM_LIGHT_KERNEL_H__
 /* plug in you favorite kernel */ 
double custom_kernel(KERNEL_PARM *kernel_parm, SVECTOR *a, SVECTOR *b){return((double)(1.0));}
#endif // __SVM_LIGHT_KERNEL_H__
